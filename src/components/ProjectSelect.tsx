...
export function ProjectSelect({ onProjectChange, disabled = false }: ProjectSelectProps) {
  ...
  // Get all customers to check archived status
  ...
  }, [projects, currentProjectId, setCurrentProject, customers])
    
// Filter out archived projects AND projects from archived customers
...
Manage projects in Customers{customersCount ? ` (${customersCount})` : ''}
</button>
</li>
</ul>
</div>

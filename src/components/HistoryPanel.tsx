        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <button
              ...
              className="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 text-left flex items-center justify-between"
            >
                ...
                {selectedProjectIds.length === 1 ? (
                  <>
                    <div
                      ...
                      style={{ backgroundColor: projects.find(p => p.id === selectedProjectIds[0])?.color || '#6b7280' }}
                    />
                    <span>{projects.find(p => p.id === selectedProjectIds[0])?.name || 'Unknown Project'}</span>
                  </>
                ) : (
            ...
            {showProjectDropdown && (
              <div className="absolute z-10 w-full mt-1 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-lg max-h-60 overflow-auto">
                <button
                  ...
                  className="w-full px-3 py-2 text-left text-sm hover:bg-gray-100 dark:hover:bg-gray-600 flex items-center"
                >
                  <span className="text-gray-900 dark:text-white">All Projects</span>
                </button>
                {projects.filter(p => {
                  // Filter out archived projects
